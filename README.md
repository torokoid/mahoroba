...
<div style="background: url(https://torokoid.github.io/mahoroba/96.JPG) no-repeat top center; background-size:contain;"><p><span class="blue"><strong> <p><a href="#" class="p">歴代の記録、<span><img src="https://torokoid.github.io/mahoroba/0216.JPG" alt="歴代の記録、"></span></a>年代のクリックで飛びます。戻るにはブラウザの戻るボタンで！ </p></strong></span></p>
